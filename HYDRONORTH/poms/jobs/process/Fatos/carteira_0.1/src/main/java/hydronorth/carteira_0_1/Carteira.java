...
public class Carteira implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		public Integer NumeroPedidoMercanet;

		public Integer getNumeroPedidoMercanet() {
			return this.NumeroPedidoMercanet;
		}

		public Boolean NumeroPedidoMercanetIsNullable() {
			return true;
		}

		public Boolean NumeroPedidoMercanetIsKey() {
			return true;
		}

		public Integer NumeroPedidoMercanetLength() {
			return 10;
		}

		public Integer NumeroPedidoMercanetPrecision() {
			return 0;
		}

		public String NumeroPedidoMercanetDefault() {

			return "";

		}

		public String NumeroPedidoMercanetComment() {

			return "";

		}

		public String NumeroPedidoMercanetPattern() {

			return "";

		}

		public String NumeroPedidoMercanetOriginalDbColumnName() {

			return "NumeroPedidoMercanet";
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result
						+ ((this.NumeroPedidoMercanet == null) ? 0 : this.NumeroPedidoMercanet.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.NumeroPedidoMercanet == null) {
				if (other.NumeroPedidoMercanet != null)
					return false;

			} else if (!this.NumeroPedidoMercanet.equals(other.NumeroPedidoMercanet))
		...
		public void copyDataTo(row2Struct other) {
			...
			other.NumeroPedidoMercanet = this.NumeroPedidoMercanet;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_HYDRONORTH_Carteira) {
				...
				try {
					...
					this.NumeroPedidoMercanet = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.NumeroPedidoMercanet, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("NumeroPedidoMercanet=" + String.valueOf(NumeroPedidoMercanet));
		...
		public String toLogString() {
			...
			if (NumeroPedidoMercanet == null) {
				sb.append("<null>");
			} else {
				sb.append(NumeroPedidoMercanet);
			}
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.NumeroPedidoMercanet, other.NumeroPedidoMercanet);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "DlUUi2_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("HOST" + " = " + "\"HYTIC04\"");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("PORT" + " = " + "\"1433\"");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("DB_SCHEMA" + " = " + "\"\"");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("DBNAME" + " = " + "\"SILVER\"");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("USER" + " = " + "\"protheus\"");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:LmykG7cJc8Y6I34PG68b0xkGcakSopGzZDwPiIjopwYeV72D+vZ/")
									.substring(0, 4) + "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"CarteiraFaturamento\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "Local_DL_Silver", "tMSSqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbname_tDBOutput_1 = "SILVER";
				String url_tDBOutput_1 = "jdbc:sqlserver://" + "HYTIC04";
				if (!"".equals(port_tDBOutput_1)) {
					url_tDBOutput_1 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBOutput_1)) {
					url_tDBOutput_1 += ";databaseName=" + "SILVER";

				}
				url_tDBOutput_1 += ";appName=" + projectName + ";" + "";
				dbUser_tDBOutput_1 = "protheus";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:SilZZDa/2/1j5i4W+SNP1EgSqG0kc4J4BIhraXbPKL+n3wM1RfOJ");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "CarteiraFaturamento";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "CarteiraFaturamento";
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([NumeroPedidoMercanet] INT ,[CodigoCliente] FLOAT(15)  ,[DataEmissao] DATETIME ,[PrevisaoEntrega] DATETIME ,[TabelaPreco] VARCHAR(8)  ,[CondicaoPagamento] INT ,[TipoOperacao] VARCHAR(10)  ,[Representante] INT ,[SituacaoPedido] TINYINT ,[SituacaoCorporativa] VARCHAR(6)  ,[SequenciaItem] INT ,[CodigoProduto] VARCHAR(16)  ,[QuantidadeProduto] REAL ,[QuantidadeAtendida] REAL ,[QuantidadeCancelada] REAL ,[PrecoUnitario] REAL ,[PrecoLiquido] REAL ,[CodigoTES] VARCHAR(10)  ,[Operacao] VARCHAR(1)  ,primary key([NumeroPedidoMercanet],[SequenciaItem],[CodigoProduto]))");
					if (log.isDebugEnabled())
				...
				pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1
						+ "] WHERE [NumeroPedidoMercanet] = ? AND [SequenciaItem] = ? AND [CodigoProduto] = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([NumeroPedidoMercanet],[CodigoCliente],[DataEmissao],[PrevisaoEntrega],[TabelaPreco],[CondicaoPagamento],[TipoOperacao],[Representante],[SituacaoPedido],[SituacaoCorporativa],[SequenciaItem],[CodigoProduto],[QuantidadeProduto],[QuantidadeAtendida],[QuantidadeCancelada],[PrecoUnitario],[PrecoLiquido],[CodigoTES],[Operacao]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1
						+ "] SET [CodigoCliente] = ?,[DataEmissao] = ?,[PrevisaoEntrega] = ?,[TabelaPreco] = ?,[CondicaoPagamento] = ?,[TipoOperacao] = ?,[Representante] = ?,[SituacaoPedido] = ?,[SituacaoCorporativa] = ?,[QuantidadeProduto] = ?,[QuantidadeAtendida] = ?,[QuantidadeCancelada] = ?,[PrecoUnitario] = ?,[PrecoLiquido] = ?,[CodigoTES] = ?,[Operacao] = ? WHERE [NumeroPedidoMercanet] = ? AND [SequenciaItem] = ? AND [CodigoProduto] = ?";
					...
					class BytesLimit65535_tFilterRow_10 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFilterRow_10
									.append("CONDITIONS" + " = " + "[{OPERATOR=" + ("==") + ", RVALUE=" + ("\"S\"")
											+ ", INPUT_COLUMN=" + ("Operacao") + ", FUNCTION=" + ("") + "}]");
							log4jParamters_tFilterRow_10.append(" | ");
				...
				util_tLogRow_1.addRow(new String[] { "NumeroPedidoMercanet", "CodigoCliente", "DataEmissao",
						"PrevisaoEntrega", "TabelaPreco", "CondicaoPagamento", "TipoOperacao", "Representante",
						"SituacaoPedido", "SituacaoCorporativa", "SequenciaItem", "CodigoProduto", "QuantidadeProduto",
						"QuantidadeAtendida", "QuantidadeCancelada", "PrecoUnitario", "PrecoLiquido", "CodigoTES",
						"Operacao", });
					...
					class BytesLimit65535_tFilterRow_8 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFilterRow_8.append("CONDITIONS" + " = " + "[{OPERATOR=" + ("==")
									+ ", RVALUE=" + ("\"0\"") + ", INPUT_COLUMN=" + ("SituacaoPedido") + ", FUNCTION="
									+ ("") + "}, {OPERATOR=" + ("==") + ", RVALUE=" + ("\"1\"") + ", INPUT_COLUMN="
									+ ("SituacaoPedido") + ", FUNCTION=" + ("") + "}]");
							log4jParamters_tFilterRow_8.append(" | ");
...
// ###############################
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:chc5cHYwNpr/GIv+0iS66cQOaBah7Rld/2GwL4HZUiVa78dUnA9nVR0I")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_2.append(" | ");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:gkSMy1kFsSnab7y3Rk7pSd6laZCGfu3zZp2xH1sqHCsySOkDBnSb39Vj");
...
// # Output table : 'Carteira'
									...
									Carteira_tmp.NumeroPedidoMercanet = Capa_pedido.NumeroPedido;
									...
									Carteira_tmp.SituacaoPedido = Capa_pedido.SituacaoPedido;
									Carteira_tmp.SituacaoCorporativa = Capa_pedido.SituacaoCorporativa;
									...
									ope_tFilterRow_8
											.matches(
													(Carteira.SituacaoPedido == null ? false
															: Carteira.SituacaoPedido.compareTo(ParserUtils
																	.parseTo_Short(String.valueOf("0"))) == 0),
													"SituacaoPedido.compareTo(\"0\") == 0 failed");

									ope_tFilterRow_8
											.matches(
													(Carteira.SituacaoPedido == null ? false
															: Carteira.SituacaoPedido.compareTo(ParserUtils
																	.parseTo_Short(String.valueOf("1"))) == 0),
													"SituacaoPedido.compareTo(\"1\") == 0 failed");

									if (ope_tFilterRow_8.getMatchFlag()) {
										if (row1 == null) {
											row1 = new row1Struct();
										}
										row1.NumeroPedidoMercanet = Carteira.NumeroPedidoMercanet;
...
///////////////////////		
										...
										if (row1.NumeroPedidoMercanet != null) { //
											row_tLogRow_1[0] = String.valueOf(row1.NumeroPedidoMercanet);

										} //

										if (row1.CodigoCliente != null) { //
											row_tLogRow_1[1] = FormatterUtils.formatUnwithE(row1.CodigoCliente);

										} //

										if (row1.DataEmissao != null) { //
											row_tLogRow_1[2] = FormatterUtils.format_Date(row1.DataEmissao,
													"dd-MM-yyyy");

										} //

										if (row1.PrevisaoEntrega != null) { //
											row_tLogRow_1[3] = FormatterUtils.format_Date(row1.PrevisaoEntrega,
													"dd-MM-yyyy");

										} //

										if (row1.TabelaPreco != null) { //
											row_tLogRow_1[4] = String.valueOf(row1.TabelaPreco);

										} //

										if (row1.CondicaoPagamento != null) { //
											row_tLogRow_1[5] = String.valueOf(row1.CondicaoPagamento);

										} //

										if (row1.TipoOperacao != null) { //
											row_tLogRow_1[6] = String.valueOf(row1.TipoOperacao);

										} //

										if (row1.Representante != null) { //
											row_tLogRow_1[7] = String.valueOf(row1.Representante);

										} //

										if (row1.SituacaoPedido != null) { //
											row_tLogRow_1[8] = String.valueOf(row1.SituacaoPedido);

										} //

										if (row1.SituacaoCorporativa != null) { //
											row_tLogRow_1[9] = String.valueOf(row1.SituacaoCorporativa);

										} //

										if (row1.SequenciaItem != null) { //
											row_tLogRow_1[10] = String.valueOf(row1.SequenciaItem);

										} //

										if (row1.CodigoProduto != null) { //
											row_tLogRow_1[11] = String.valueOf(row1.CodigoProduto);

										} //

										if (row1.QuantidadeProduto != null) { //
											row_tLogRow_1[12] = FormatterUtils.formatUnwithE(row1.QuantidadeProduto);

										} //

										if (row1.QuantidadeAtendida != null) { //
											row_tLogRow_1[13] = FormatterUtils.formatUnwithE(row1.QuantidadeAtendida);

										} //

										if (row1.QuantidadeCancelada != null) { //
											row_tLogRow_1[14] = FormatterUtils.formatUnwithE(row1.QuantidadeCancelada);

										} //

										if (row1.PrecoUnitario != null) { //
											row_tLogRow_1[15] = FormatterUtils.formatUnwithE(row1.PrecoUnitario);

										} //

										if (row1.PrecoLiquido != null) { //
											row_tLogRow_1[16] = FormatterUtils.formatUnwithE(row1.PrecoLiquido);

										} //

										if (row1.CodigoTES != null) { //
											row_tLogRow_1[17] = String.valueOf(row1.CodigoTES);

										} //

										if (row1.Operacao != null) { //
											row_tLogRow_1[18] = String.valueOf(row1.Operacao);
...
///////////////////////    			
										...
										if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
												...
												, "row3", "tLogRow_1", "tLogRow_1", "tLogRow", "tFilterRow_10",
												"Filtro vendas", "tFilterRow"
										...
										ope_tFilterRow_10.matches(
												(row3.Operacao == null ? false : row3.Operacao.compareTo("S") == 0),
												"Operacao.compareTo(\"S\") == 0 failed");

										if (ope_tFilterRow_10.getMatchFlag()) {
											if (row2 == null) {
												row2 = new row2Struct();
											}
											row2.NumeroPedidoMercanet = row3.NumeroPedidoMercanet;
											row2.CodigoCliente = row3.CodigoCliente;
											row2.DataEmissao = row3.DataEmissao;
											row2.PrevisaoEntrega = row3.PrevisaoEntrega;
											row2.TabelaPreco = row3.TabelaPreco;
											row2.CondicaoPagamento = row3.CondicaoPagamento;
											row2.TipoOperacao = row3.TipoOperacao;
											row2.Representante = row3.Representante;
											row2.SituacaoPedido = row3.SituacaoPedido;
											row2.SituacaoCorporativa = row3.SituacaoCorporativa;
											row2.SequenciaItem = row3.SequenciaItem;
											row2.CodigoProduto = row3.CodigoProduto;
											row2.QuantidadeProduto = row3.QuantidadeProduto;
											row2.QuantidadeAtendida = row3.QuantidadeAtendida;
											row2.QuantidadeCancelada = row3.QuantidadeCancelada;
											row2.PrecoUnitario = row3.PrecoUnitario;
											row2.PrecoLiquido = row3.PrecoLiquido;
											row2.CodigoTES = row3.CodigoTES;
											row2.Operacao = row3.Operacao;
											log.debug("tFilterRow_10 - Process the record "
													+ (nb_line_tFilterRow_10 + 1) + ".");
...
// Start of branch "row2"
										if (row2 != null) {
											...
											if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
													...
													, "row2", "tFilterRow_10", "Filtro vendas", "tFilterRow",
													"tDBOutput_1", "Local_DL_Silver", "tMSSqlOutput"
											...
											if (row2.NumeroPedidoMercanet == null) {
												pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
											} else {
												pstmt_tDBOutput_1.setInt(1, row2.NumeroPedidoMercanet);
											}

											if (row2.SequenciaItem == null) {
												pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
											} else {
												pstmt_tDBOutput_1.setInt(2, row2.SequenciaItem);
											}

											if (row2.CodigoProduto == null) {
												pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(3, row2.CodigoProduto);
											}
											...
											if (checkCount_tDBOutput_1 > 0) {
												if (row2.CodigoCliente == null) {
													pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.DOUBLE);
												} else {
													pstmtUpdate_tDBOutput_1.setDouble(1, row2.CodigoCliente);
												}

												if (row2.DataEmissao != null) {
													pstmtUpdate_tDBOutput_1.setTimestamp(2,
															new java.sql.Timestamp(row2.DataEmissao.getTime()));
												} else {
													pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
												}

												if (row2.PrevisaoEntrega != null) {
													pstmtUpdate_tDBOutput_1.setTimestamp(3,
															new java.sql.Timestamp(row2.PrevisaoEntrega.getTime()));
												} else {
													pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
												}

												if (row2.TabelaPreco == null) {
													pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(4, row2.TabelaPreco);
												}

												if (row2.CondicaoPagamento == null) {
													pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
												} else {
													pstmtUpdate_tDBOutput_1.setInt(5, row2.CondicaoPagamento);
												}

												if (row2.TipoOperacao == null) {
													pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(6, row2.TipoOperacao);
												}

												if (row2.Representante == null) {
													pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
												} else {
													pstmtUpdate_tDBOutput_1.setInt(7, row2.Representante);
												}

												if (row2.SituacaoPedido == null) {
													pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
												} else {
													pstmtUpdate_tDBOutput_1.setShort(8, row2.SituacaoPedido);
												}

												if (row2.SituacaoCorporativa == null) {
													pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(9, row2.SituacaoCorporativa);
												}

												if (row2.QuantidadeProduto == null) {
													pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.FLOAT);
												} else {
													pstmtUpdate_tDBOutput_1.setFloat(10, row2.QuantidadeProduto);
												}

												if (row2.QuantidadeAtendida == null) {
													pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.FLOAT);
												} else {
													pstmtUpdate_tDBOutput_1.setFloat(11, row2.QuantidadeAtendida);
												}

												if (row2.QuantidadeCancelada == null) {
													pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.FLOAT);
												} else {
													pstmtUpdate_tDBOutput_1.setFloat(12, row2.QuantidadeCancelada);
												}

												if (row2.PrecoUnitario == null) {
													pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.FLOAT);
												} else {
													pstmtUpdate_tDBOutput_1.setFloat(13, row2.PrecoUnitario);
												}

												if (row2.PrecoLiquido == null) {
													pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.FLOAT);
												} else {
													pstmtUpdate_tDBOutput_1.setFloat(14, row2.PrecoLiquido);
												}

												if (row2.CodigoTES == null) {
													pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(15, row2.CodigoTES);
												}

												if (row2.Operacao == null) {
													pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(16, row2.Operacao);
												}

												if (row2.NumeroPedidoMercanet == null) {
													pstmtUpdate_tDBOutput_1.setNull(17 + count_tDBOutput_1,
															java.sql.Types.INTEGER);
												} else {
													pstmtUpdate_tDBOutput_1.setInt(17 + count_tDBOutput_1,
															row2.NumeroPedidoMercanet);
												}

												if (row2.SequenciaItem == null) {
													pstmtUpdate_tDBOutput_1.setNull(18 + count_tDBOutput_1,
															java.sql.Types.INTEGER);
												} else {
													pstmtUpdate_tDBOutput_1.setInt(18 + count_tDBOutput_1,
															row2.SequenciaItem);
												}

												if (row2.CodigoProduto == null) {
													pstmtUpdate_tDBOutput_1.setNull(19 + count_tDBOutput_1,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_1.setString(19 + count_tDBOutput_1,
															row2.CodigoProduto);
												}
												...
												if (row2.NumeroPedidoMercanet == null) {
													...
													pstmtInsert_tDBOutput_1.setInt(1, row2.NumeroPedidoMercanet);
												}

												if (row2.CodigoCliente == null) {
													pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.DOUBLE);
												} else {
													pstmtInsert_tDBOutput_1.setDouble(2, row2.CodigoCliente);
												}
												...
												if (row2.TabelaPreco == null) {
													...
													pstmtInsert_tDBOutput_1.setString(5, row2.TabelaPreco);
												}

												if (row2.CondicaoPagamento == null) {
													pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
												} else {
													pstmtInsert_tDBOutput_1.setInt(6, row2.CondicaoPagamento);
												}

												if (row2.TipoOperacao == null) {
													pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(7, row2.TipoOperacao);
												}

												if (row2.Representante == null) {
													pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
												} else {
													pstmtInsert_tDBOutput_1.setInt(8, row2.Representante);
												}

												if (row2.SituacaoPedido == null) {
													pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
												} else {
													pstmtInsert_tDBOutput_1.setShort(9, row2.SituacaoPedido);
												}

												if (row2.SituacaoCorporativa == null) {
													pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(10, row2.SituacaoCorporativa);
												}

												if (row2.SequenciaItem == null) {
													pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
												} else {
													pstmtInsert_tDBOutput_1.setInt(11, row2.SequenciaItem);
												}

												if (row2.CodigoProduto == null) {
													pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(12, row2.CodigoProduto);
												}

												if (row2.QuantidadeProduto == null) {
													pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.FLOAT);
												} else {
													pstmtInsert_tDBOutput_1.setFloat(13, row2.QuantidadeProduto);
												}

												if (row2.QuantidadeAtendida == null) {
													pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.FLOAT);
												} else {
													pstmtInsert_tDBOutput_1.setFloat(14, row2.QuantidadeAtendida);
												}

												if (row2.QuantidadeCancelada == null) {
													pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.FLOAT);
												} else {
													pstmtInsert_tDBOutput_1.setFloat(15, row2.QuantidadeCancelada);
												}

												if (row2.PrecoUnitario == null) {
													pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.FLOAT);
												} else {
													pstmtInsert_tDBOutput_1.setFloat(16, row2.PrecoUnitario);
												}

												if (row2.PrecoLiquido == null) {
													pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.FLOAT);
												} else {
													pstmtInsert_tDBOutput_1.setFloat(17, row2.PrecoLiquido);
												}

												if (row2.CodigoTES == null) {
													pstmtInsert_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(18, row2.CodigoTES);
												}

												if (row2.Operacao == null) {
													pstmtInsert_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
												} else {
													pstmtInsert_tDBOutput_1.setString(19, row2.Operacao);
												}
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tFilterRow_10", "Filtro vendas", "tFilterRow",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tFilterRow_10", "Filtro vendas", "tFilterRow", "tDBOutput_1", "Local_DL_Silver",
						"tMSSqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "PzG3L0_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(Capa_pedido,TIpo_operacao,Itens_pedido)
				// outputs:(Carteira)
					...
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:YuM3y9ajANEwd5wDyWmWbhuML8gJatGUqXmD4v2x8nvLIZj/4dHy96LT")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_3.append(" | ");
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PXe+6tlmBGS8iPzmjW8zj2Exj6pGXa84KqOOyGhTWu9kBUd+ribHWZKA");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "hRyZ7f_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:FUTA7SYOblbL7jK+MNVS+IjkGZaK7PyD3y1BzuteOQApLAGkcWnf8pYe")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:217lRMZKVNOvIF++izJhLOToyw7xAUEV/iP1db0roXBmOl2ajS887oFW");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-07-31T13:33:43.109041600Z");
...
/************************************************************************************************
 * 1108797 characters generated by Talend Cloud Data Integration on the 31 de
 * julho de 2024 10:33:43 BRT
 ************************************************************************************************/