...
package hydronorth.inclusao_funcionario_0_1;
...
/**
 * Job: Inclusao_Funcionario Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status DEV
 */
public class Inclusao_Funcionario implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Inclusao_Funcionario.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Inclusao_Funcionario.class);
	...
	private final String jobName = "Inclusao_Funcionario";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Inclusao_Funcionario.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Inclusao_Funcionario.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_HYDRONORTH_Inclusao_Funcionario = new byte[0];
		static byte[] commonByteArray_HYDRONORTH_Inclusao_Funcionario = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_HYDRONORTH_Inclusao_Funcionario.length) {
					if (length < 1024 && commonByteArray_HYDRONORTH_Inclusao_Funcionario.length == 0) {
						commonByteArray_HYDRONORTH_Inclusao_Funcionario = new byte[1024];
					} else {
						commonByteArray_HYDRONORTH_Inclusao_Funcionario = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_HYDRONORTH_Inclusao_Funcionario, 0, length);
				strReturn = new String(commonByteArray_HYDRONORTH_Inclusao_Funcionario, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_HYDRONORTH_Inclusao_Funcionario, 0, length);
				strReturn = new String(commonByteArray_HYDRONORTH_Inclusao_Funcionario, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_HYDRONORTH_Inclusao_Funcionario) {
	...
	public void tREST_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "qlREQn_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tREST_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tREST_1
									.append("URL" + " = " + "\"https://labapi1.galera.app/api/v1/o/token/\"");
							log4jParamters_tREST_1.append(" | ");
							log4jParamters_tREST_1.append("METHOD" + " = " + "POST");
							log4jParamters_tREST_1.append(" | ");
							log4jParamters_tREST_1
									.append("HEADERS" + " = " + "[{VALUE=" + ("\"application/x-www-form-urlencoded\"")
											+ ", NAME=" + ("\"Content-Type\"") + "}]");
							log4jParamters_tREST_1.append(" | ");
							log4jParamters_tREST_1.append("BODY" + " = "
									+ "\"username:api_hydronorth-02\\\\  password:Jvbs@05082001**\\\\  client_id:kf9d78h8mr6rgv23d3b6\\\\  client_secret:6eyuks8cya7c888pc338\\\\  grant_type:password\"");
							log4jParamters_tREST_1.append(" | ");
							if (log.isDebugEnabled())
				...
				String endpoint_tREST_1 = "https://labapi1.galera.app/api/v1/o/token/";
				...
				headers_tREST_1.put("Content-Type", "application/x-www-form-urlencoded");
				...
				try {
					...
					if (builder_tREST_1 != null) {
						restResponse_tREST_1 = builder_tREST_1.post(String.class,
								"username:api_hydronorth-02\\  password:Jvbs@05082001**\\  client_id:kf9d78h8mr6rgv23d3b6\\  client_secret:6eyuks8cya7c888pc338\\  grant_type:password");
					} else {
						restResponse_tREST_1 = restResource_tREST_1.post(String.class,
								"username:api_hydronorth-02\\  password:Jvbs@05082001**\\  client_id:kf9d78h8mr6rgv23d3b6\\  client_secret:6eyuks8cya7c888pc338\\  grant_type:password");
					}
				...
				if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
						...
						, "row1", "tREST_1", "tREST_1", "tREST", "tLogRow_1", "tLogRow_1", "tLogRow"
...
///////////////////////		
				...
				if (row1.ERROR_CODE != null) { //
					...
					strBuffer_tLogRow_1.append(String.valueOf(row1.ERROR_CODE));
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0, "tREST_1",
						"tREST_1", "tREST", "tLogRow_1", "tLogRow_1", "tLogRow", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final Inclusao_Funcionario Inclusao_FuncionarioClass = new Inclusao_Funcionario();

		int exitCode = Inclusao_FuncionarioClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Inclusao_Funcionario' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Inclusao_Funcionario' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_DoIJYFl6Ee-r5dP3fNz1cQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-08-15T13:22:17.741367900Z");
		...
		try {
			...
			java.io.InputStream inContext = Inclusao_Funcionario.class.getClassLoader()
					.getResourceAsStream("hydronorth/inclusao_funcionario_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Inclusao_Funcionario.class.getClassLoader()
		...
		log.info("TalendJob: 'Inclusao_Funcionario' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Inclusao_Funcionario");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Inclusao_Funcionario' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 67521 characters generated by Talend Cloud Data Integration on the 15 de
 * agosto de 2024 10:22:17 BRT
 ************************************************************************************************/